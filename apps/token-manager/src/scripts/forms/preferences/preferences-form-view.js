...
import DisplayPrefsFormView from '../../../../../views/apps/token-manager/forms/preferences/display-prefs-form-view.js';
import WindowPrefsFormView from '../../../../../views/apps/token-manager/forms/preferences/window-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('token_manager');
				break;
			case 'display':
